...
document.addEventListener("DOMContentLoaded", function() {
    ...
    let confirmButton = document.getElementById("confirm9thclasses")
    ...
    confirmButton.addEventListener("mouseup", function() {
        ...
        document.getElementById("9thsetupformcontainer").classList.remove("level-select-visible")
        document.getElementById("9thsetupformcontainer").classList.add("level-select-hidden")

        let allh5s = document.getElementsByClassName("selected9thClass")
