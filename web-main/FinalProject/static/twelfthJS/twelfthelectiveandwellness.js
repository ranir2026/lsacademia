...
$.ajax({
    ...
    success: function(response) {
        ...
        regWellnessDiv12 = document.getElementById('wellnessElectiveSelect12');
        ...
        for (let i=0; i<keys.length; i++) {
            ...
            // THIS IS FOR 12th GRADE REGULAR ELECTIVE

            let regElectiveDiv12 = document.getElementById('regElectiveDiv12')
            ...
            function hideYearLongs() {
                let yearElectives = document.getElementById("yearElective12container")
            ...
            function hideSemesterLongs() {
                let yearElectives = document.getElementById("semesterElective12container")
                yearElectives.classList.add('elective-select-hidden')
                yearElectives.classList.remove('elective-select-visible')
            }
            ...
            let semesterElective12 = document.getElementById('semesterElective12')
            ...
            if ((POS[keys[i]]['Subject'] === 'FATA' || POS[keys[i]]['Subject'] === 'Elective' || POS[keys[i]]['Subject'] === 'Digital Literacy and Computer Science (DLCS)') && POS[keys[i]]['Grades Open'] === "9-12" && POS[keys[i]]['Duration'] === "Semester") {
                ...
                semesterElective12.appendChild(wrapper);

            };

            // year LONG ELECTIVES

            let yearElective12 = document.getElementById('yearElective12')

            if ((POS[keys[i]]['Subject'] === 'FATA' || POS[keys[i]]['Subject'] === 'Elective' || POS[keys[i]]['Subject'] === 'Digital Literacy and Computer Science (DLCS)') && POS[keys[i]]['Duration'] === "Full") {
                ...
                //append the wrapper for each button to the div in the class
                yearElective12.appendChild(wrapper);
