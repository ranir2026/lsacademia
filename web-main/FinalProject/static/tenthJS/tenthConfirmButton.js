...
document.addEventListener("DOMContentLoaded", function() {
    ...
    let confirmButton = document.getElementById("confirm10thclasses")
    ...
    confirmButton.addEventListener("mouseup", function() {
        ...
        document.getElementById("10thsetupformcontainer").classList.remove("level-select-visible")
        document.getElementById("10thsetupformcontainer").classList.add("level-select-hidden")

        let allh5s = document.getElementsByClassName("selected10thClass")
