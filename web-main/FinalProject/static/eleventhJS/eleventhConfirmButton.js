...
document.addEventListener("DOMContentLoaded", function() {
    ...
    let confirmButton = document.getElementById("confirm11thclasses")
    ...
    confirmButton.addEventListener("mouseup", function() {
        ...
        document.getElementById("11thsetupformcontainer").classList.remove("level-select-visible")
        document.getElementById("11thsetupformcontainer").classList.add("level-select-hidden")

        let allh5s = document.getElementsByClassName("selected11thClass")
        ...
        for (let i=0; i<selectedClasses.length; i++) {
            ...
            for (let i=0; i<keys.length; i++) {
                ...
                if (POS[keys[i]]['Course Name'].toUpperCase().trim() === nameOfClass.innerText.toUpperCase().trim()) {
                    ...
                    } // don't add anything if it doesn't meet global scholars like
